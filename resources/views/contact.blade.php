...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto my-8 p-6 bg-white rounded-lg shadow-md">
        <h1 class="text-3xl font-bold text-blue-600">Hubungi Kami</h1>
        <p class="mt-4 text-gray-700">Untuk informasi lebih lanjut, Anda dapat menghubungi kami melalui email: <a href="febrianirani487@gmail.com" class="text-blue-500 underline">febrianirani487@gmail.com</a>.</p>
    </div>
